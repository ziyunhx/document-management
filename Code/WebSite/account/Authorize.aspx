<%@ Page Title="角色授权" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Authorize.aspx.cs" Inherits="account_Authorize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPH_main" Runat="Server">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
		...
		<tr><td class="doaction" align="left">角色ID：<input type="text" runat="server" readonly="readonly" id="rid" style="width: 29px" />
