<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="AuditDocument.aspx.cs" Inherits="document_AuditDocument" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPH_main" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true">
		...
		<tr><td width="100%" height="26" style="padding-left:10px;" class="leftmenu">当前位置：公文管理 >>审核公文</td></tr>
            ...
            <asp:GridView ID="GridView1" runat="server" HeaderStyle-BackColor="Coral" Width="100%"  DataKeyNames="ID" BorderWidth="1px" BorderStyle="Dotted" CellPadding="3" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>                            
                            <a href="/document/DocumentSH.aspx?id=<%# Eval("id").ToString()%>">审核公文</a> &nbsp;              
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
